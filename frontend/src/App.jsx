...
const I18N = {
  en: { newTask:'New Task',send:'Send',settings:'Settings',save:'Saved',noConvs:'No conversations',
    ...
    files:'Files',monitor:'Monitor',activity:'Activity',back:'Back',log:'Log',
    stop:'Stop',cancel:'Cancel',edit:'Edit',rerun:'Re-run',
    viewMonitor:'View in Monitor',waiting:'Waiting for task...',
    noActivity:'No activity recorded',noFiles:'No files yet',
    download:'Download',uploadFile:'Upload file',startTask:'Start a New Task',
    openMonitor:'Open Monitor',output:'Output' },
  zh: { newTask:'新建任务',send:'发送',settings:'设置',save:'已保存',noConvs:'暂无对话',
    ...
    agents:'Agent',groups:'组',retries:'次重试',analyzing:'分析任务中',
    files:'文件',monitor:'监控',activity:'活动',back:'返回',log:'日志',
    stop:'停止',cancel:'取消',edit:'编辑',rerun:'重新执行',
    viewMonitor:'查看监控',waiting:'等待任务...',
    noActivity:'暂无活动',noFiles:'暂无文件',
    download:'下载',uploadFile:'上传文件',startTask:'开始新任务',
    openMonitor:'打开监控',output:'输出' },
}
